...
import androidx.compose.material3.PlainTooltip as PlainTooltip1
        ...
        LazyColumn(
            ...
            item {
                Card(modifier = Modifier
                    ...
                    onClick = { changenamebottomsheet = true }
                ) {
                    Row(
                        modifier = Modifier
                            .fillMaxWidth()
                ...
                Card(modifier = Modifier
                    ...
                    onClick = { checkforupdatebottomsheet = true }
                ) {
                    Row(
                        modifier = Modifier
                            .fillMaxWidth()
                ...
                Card(modifier = Modifier
                    ...
                    onClick = { whatsnewbottomsheet = true }
                ) {
                    Row(
                        modifier = Modifier
                            .fillMaxWidth()
